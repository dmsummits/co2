...
<head>
		...
		<title>Summits Hygronics | Co2 Capture Company</title>
    ...
    height: 58px;
       ...
       ?>
            ...
            <div class="intro-carousel">
                <div class="intro-content">
                    <div class="slider-images">
                        <img src="img/images/Slide1.png" alt="">
                    </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <!-- layer 1 -->
                                            <div class="layer-1-2">
                                                <h1 class="title2">Summits India's Best Co<sub>2</sub> Capture</h1>
                                            </div>
                                            <div class="layer-1-1">
                                                <p>Green Initiative of Summits</p>
                                            </div>
                                            <!-- layer 3 -->
                                            <!-- <div class="layer-1-3">
                ...
                <div class="intro-content">
                    <div class="slider-images">
                        <img src="img/images/slider2.png" alt="">
                    </div>
                    <div class="slider-content">
                        <div class="display-table">
                            <div class="display-table-cell">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <!-- layer 1 -->
                                            <div class="layer-1-2">
                                                <h1 class="title2">Carbon Dioxide Capture</h1>
                                            </div>
                                            <div class="layer-1-1 ">
                                                <p>Summits Hygronics Private Limited - a leading manufacturer of Air drying plants, Medical Oxygen plants and Nitrogen Generating plants. </p>
                                            </div>
                                            <!-- layer 3 -->
                                            <!-- <div class="layer-1-3">
                                                <a href="#" class="ready-btn left-btn" >Our Services</a>
        ...
        <!-- End Slider Area -->
         <!-- about-area start -->
         <div class="about-area bg-color area-padding" id="solution"> 
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="about-image">
                            <img src="img/images/3. Blower reactivated air dryer.jpg" alt="">
                        </div>
                    </div>
                    <!-- column end -->
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="about-content">
							<h4>CO2 Capturing Systems, Medical Oxygen Generators, Air Dryers and Nitrogen Generators<span class="color"> - Summits Hygronics  </span></h4>
                            <p>Summits Hygronics an ISO:9001 / ISO 14001/ ISO 45001 / ISO13485 company offers a complete range of products and solutions for CO2 Capturing Systems, Compressed air purification, Oxygen and Nitrogen generation - All types of air dryers, PSA medical Oxygen generators, PSA and Membrane Nitrogen Generators and allied accessories.</p>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="video-text">
                        <div class="left-headline">
						    <h3>
                                Why<span class="color"> Summits... </span></h3>
                        ...
                        <ul class="marker-list">
                            <li>More than 25 years of experience, executing regular OE business to establishments like Elgi Equipments, Ingersoll Rand, Hitachi -Sullair, Kaeser, etc</li>
                            <li>One among the top Air Dryer and Medical Oxygen Generator Manufacturers in India in terms of business value</li>
                            <li>Enlistment by EIL, NTPC, BHEL, MECON, NPCIL, TATA Projects, etc</li>
                            <li>Robust design & engineering ensures up-to-date world class products
    ...
    <!-- End About Area -->
                        ...
                        <div class="company-content">
                        	<div class="main-view">
								<div class="single-view">
									...
									<div class="view-content">
										<h4>The Summits way</h4>
										 <p>The core strength of our business is offering unique tailor made air dryers and allied  products for various sectors including clean environment, health care oil & gas, power, space research, defence, automobile, textiles, pharmaceuticals and many more.</p>
									</div>
								</div>
							</div>
							<!-- End single-view -->
							<div class="main-view">
								<div class="single-view">
									...
									<div class="view-content">
										<h4>Manufacturing excellance</h4>
										 <p>Summits infrastructure is one of the best in manufacturing air dryers, nitrogen generators, oxygen generators with state of art modern and automatic machinery and skilled man power.
						   ...
						   <div class="main-view">
								<div class="single-view">
									...
									<div class="view-content">
										<h4>
                                            Innovation</h4>
										 <p>Summits always strive to provide the latest and best technology products to customers. The products are designed for best energy efficiency, environment friendly and space saving.
        ...
        <!-- End project Area -->
        <!-- Start Brand Area -->
        <div class="brand-area area-padding" style="padding-top: 70px;">
            <div class="container">
                <div class="row">
